...
const AccountingLogo = () => (
  <svg width="140" height="36" viewBox="0 0 140 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Meridian CPA logo">
    <rect x="2" y="18" width="7" height="14" rx="1.5" fill="#1a6b4a" />
    <rect x="12" y="11" width="7" height="21" rx="1.5" fill="#1a6b4a" />
    <rect x="22" y="5" width="7" height="27" rx="1.5" fill="#1a6b4a" />
    <path d="M25.5 2L29 5.5L25.5 9" stroke="#1a6b4a" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
...
export const TopNavigationSection = (): JSX.Element => {
  return (
    <header className="fixed top-0 left-0 z-50 flex w-full items-center bg-[#0d2b1e]/90 backdrop-blur-sm px-[50px] py-4">
